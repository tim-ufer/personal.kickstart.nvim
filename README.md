...
```sh
git clone https://github.com/tim-ufer/personal.kickstart.nvim "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/tim-ufer/personal.kickstart.nvim "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/tim-ufer/personal.kickstart.nvim "${env:LOCALAPPDATA}\nvim"
```
